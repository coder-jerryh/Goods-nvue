...
class RewardedVideo extends AdBase {
  constructor (options = {}) {
    super(AD_OBJECT.createRewardedVideoAd(options), options)
  }
}

class FullScreenVideo extends AdBase {
  constructor (options = {}) {
    super(AD_OBJECT.createFullScreenVideoAd(options), options)
  }
}
class InterstitialAd extends AdBase {
  constructor (options = {}) {
    super(AD_OBJECT.createInterstitialAd(options), options)
  }
}
